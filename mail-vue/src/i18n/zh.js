const zh = {
    ...
    gotIt: '我知道了',
    guideWriteEmail: '写邮件',
    guideWriteEmailDesc: '点击侧边栏顶部的编辑按钮撰写新邮件，双击则在新窗口打开',
    guideSidebar: '侧边栏展开/收起',
    guideSidebarDesc: '点击左上角菜单按钮切换侧边栏宽度，悬停在窄侧边栏上可自动展开',
    guideDblClick: '双击操作',
    guideDblClickDesc: '双击邮件列表 → 新窗口查看详情；双击回复/转发 → 新窗口撰写；双击发送按钮 → 新窗口发送',
    guideCompact: '紧凑模式',
    guideCompactDesc: '点击图标切换邮件列表的紧凑多行布局（发件人/标题/内容分行显示）',
    guideReplyFwd: '回复 / 回复全部 / 转发',
    guideReplyFwdDesc: '单击在当前页面回复/转发，双击在新窗口操作。回复全部仅在有多个收件人时显示',
    guideStar: '星标',
    guideStarDesc: '点击星标图标收藏或取消收藏邮件',
    guideClose: '关闭预览',
    guideCloseDesc: '点击 X 关闭当前邮件预览面板',
    guideBgZoom: '背景切换 / 缩放',
    guideBgZoomDesc: '在深色模式下点击可切换白色背景；加号/减号缩放邮件内容（每次10%）',
    guideAttachment: '附件',
    guideAttachmentDesc: '撰写邮件时点击回形针图标添加附件，图片附件可点击预览',
    guideSignature: '签名',
    guideSignatureDesc: '撰写邮件时点击笔图标插入签名，可在主窗口管理多个签名'
}
export default zh
