<template>
  <div class="box">
    <div class="header-actions">
      ...
      <Icon class="icon" v-if="emailStore.contentData.showReply" v-perm="'email:send'"  @click="openReply" @dblclick="dblClickReply" icon="la:reply" width="21" height="21" />
      <Icon class="icon" v-if="emailStore.contentData.showReply" v-perm="'email:send'"  @click="openForward" @dblclick="dblClickForward" icon="iconoir:arrow-up-right" width="20" height="20" />
    </div>
    <div></div>
